...
Usage: python tests/integration_check.py
"""
import os
import sys
...
def main():
    ...
    _orig_posts = ApifyConnector.scrape_facebook_posts
    _orig_comments = ApifyConnector.scrape_facebook_comments
    ...
    _orig_analyze = comment_ai.analyze_comments_for_post
    ...
    try:
        ...
        ApifyConnector.scrape_facebook_posts = _orig_posts
        ApifyConnector.scrape_facebook_comments = _orig_comments
        comment_ai.analyze_comments_for_post = _orig_analyze
        db.facebook_pages.delete_many({})
        db.facebook_posts.delete_many({})
        db.facebook_comments.delete_many({})
